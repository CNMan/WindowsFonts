...
mv aldhabi.ttf andlso.ttf arabtype.ttf majalla.ttf majallab.ttf msuighub.ttf msuighur.ttf simpbdo.ttf simpfxo.ttf simpo.ttf tradbdo.ttf trado.ttf UrdType.ttf UrdTypeb.ttf arab/
mv Shonar.ttf Shonarb.ttf vrinda.ttf vrindab.ttf beng/
mv euphemia.ttf cans/
mv plantc.ttf cher/
mv aparaj.ttf aparajb.ttf aparajbi.ttf aparaji.ttf kokila.ttf kokilab.ttf kokilabi.ttf kokilai.ttf mangal.ttf mangalb.ttf Sanskr.ttf utsaah.ttf utsaahb.ttf utsaahbi.ttf utsaahi.ttf deva/
mv nyala.ttf ethi/
...
mv ArialNova.ttf ArialNova-Bold.ttf ArialNova-BoldItalic.ttf ArialNovaCond.ttf ArialNovaCond-Bold.ttf ArialNovaCond-BoldItalic.ttf ArialNovaCond-Italic.ttf ArialNovaCond-Light.ttf ArialNovaCond-LightItalic.ttf ArialNova-Italic.ttf ArialNova-Light.ttf ArialNova-LightItalic.ttf GeorgiaPro-Black.ttf GeorgiaPro-BlackItalic.ttf GeorgiaPro-Bold.ttf GeorgiaPro-BoldItalic.ttf GeorgiaPro-CondBlack.ttf GeorgiaPro-CondBlackItalic.ttf GeorgiaPro-CondBold.ttf GeorgiaPro-CondBoldItalic.ttf GeorgiaPro-CondItalic.ttf GeorgiaPro-CondLight.ttf GeorgiaPro-CondLightItalic.ttf GeorgiaPro-CondRegular.ttf GeorgiaPro-CondSemiBold.ttf GeorgiaPro-CondSemiBoldItalic.ttf GeorgiaPro-Italic.ttf GeorgiaPro-Light.ttf GeorgiaPro-LightItalic.ttf GeorgiaPro-Regular.ttf GeorgiaPro-SemiBold.ttf GeorgiaPro-SemiBoldItalic.ttf GillSansBoItNova.ttf GillSansBoNova.ttf GillSansCondBoItNova.ttf GillSansCondBoNova.ttf GillSansCondExtraItNova.ttf GillSansCondExtraNova.ttf GillSansCondItNova.ttf GillSansCondLightItNova.ttf GillSansCondLightNova.ttf GillSansCondNova.ttf GillSansCondUltraBoNova.ttf GillSansItNova.ttf GillSansLightItNova.ttf GillSansLightNova.ttf GillSansNova.ttf GillSansUltraBoNova.ttf NHaasGroteskTXPro-55Rg.ttf NHaasGroteskTXPro-56It.ttf NHaasGroteskTXPro-65Md.ttf NHaasGroteskTXPro-66MdIt.ttf NHaasGroteskTXPro-75Bd.ttf NHaasGroteskTXPro-76BdIt.ttf RockwellNova.ttf RockwellNova-Bold.ttf RockwellNova-BoldItalic.ttf RockwellNovaCond.ttf RockwellNovaCond-Bold.ttf RockwellNovaCond-BoldItalic.ttf RockwellNovaCond-Italic.ttf RockwellNovaCond-Light.ttf RockwellNovaCond-LightItalic.ttf RockwellNova-ExtraBold.ttf RockwellNova-ExtraBoldItalic.ttf RockwellNova-Italic.ttf RockwellNova-Light.ttf RockwellNova-LightItalic.ttf VerdanaPro-Black.ttf VerdanaPro-BlackItalic.ttf VerdanaPro-Bold.ttf VerdanaPro-BoldItalic.ttf VerdanaPro-CondBlack.ttf VerdanaPro-CondBlackItalic.ttf VerdanaPro-CondBold.ttf VerdanaPro-CondBoldItalic.ttf VerdanaPro-CondItalic.ttf VerdanaPro-CondLight.ttf VerdanaPro-CondLightItalic.ttf VerdanaPro-CondRegular.ttf VerdanaPro-CondSemiBold.ttf VerdanaPro-CondSemiBoldItalic.ttf VerdanaPro-Italic.ttf VerdanaPro-Light.ttf VerdanaPro-LightItalic.ttf VerdanaPro-Regular.ttf VerdanaPro-SemiBold.ttf VerdanaPro-SemiBoldItalic.ttf latn/
mv iskpota.ttf iskpotab.ttf sinh/
mv estre.ttf syrc/
...
sha1sum cans/*.tt* > cans/sha1sum
sha1sum cher/*.tt* > cher/sha1sum
sha1sum deva/*.tt* > deva/sha1sum
sha1sum ethi/*.tt* > ethi/sha1sum
sha1sum gujr/*.tt* > gujr/sha1sum
sha1sum guru/*.tt* > guru/sha1sum
sha1sum hans/*.tt* > hans/sha1sum
sha1sum hant/*.tt* > hant/sha1sum
sha1sum hebr/*.tt* > hebr/sha1sum
sha1sum jpan/*.tt* > jpan/sha1sum
sha1sum khmr/*.tt* > khmr/sha1sum
sha1sum knda/*.tt* > knda/sha1sum
sha1sum kore/*.tt* > kore/sha1sum
sha1sum laoo/*.tt* > laoo/sha1sum
sha1sum mlym/*.tt* > mlym/sha1sum
sha1sum orya/*.tt* > orya/sha1sum
sha1sum latn/*.tt* > latn/sha1sum
sha1sum sinh/*.tt* > sinh/sha1sum
sha1sum syrc/*.tt* > syrc/sha1sum
sha1sum taml/*.tt* > taml/sha1sum
sha1sum telu/*.tt* > telu/sha1sum
